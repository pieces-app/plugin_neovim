...
from pieces_python._pieces_lib import websocket
from pieces_python._pieces_lib.websocket._exceptions import WebSocketProxyException, WebSocketException
from pieces_python._pieces_lib.websocket._http import (
    _get_addrinfo_list,
...
try:
    ...
    from pieces_python._pieces_lib.websocket._http import ProxyConnectionError, ProxyError, ProxyTimeoutError
